                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        INSERT INTO personalinfo (
                            userID, FirstName, MiddleName, LastName, Suffix, Region, Province, Town, Barangay, Street, ZipCode,
                            CellphoneNumber, LandlineNumber, CivilStatus, Sex, DateOfBirth, PlaceOfBirth, Religion, Indigenous
                        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
