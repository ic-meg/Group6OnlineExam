...
function sendemail_with_control_number($EmailAddress, $control_number) {
    ...
    $message .= "<a href='http://localhost/Group6OnlineExam/Guess.php'>Online Exam Portal</a><br><br>";
...
$filename = 'C:\xampp\htdocs\Group6OnlineExam\Admission\control_numbers.xlsx'; // Desired filename
