document.addEventListener("DOMContentLoaded", function () {
  const resetButton = document.querySelector(
    'button[name="saveMedical"][value="Reset Medical Information"]'
  );
  const resetModal = new bootstrap.Modal(document.getElementById("resetModal"));
  const successModal = new bootstrap.Modal(
    document.getElementById("successModal")
  );
  const resetSuccessModal = new bootstrap.Modal(
  ...
  if (resetForm) {
    resetForm.addEventListener("submit", function (event) {
      ...
      xhr.open("POST", "reset_medical.php", true);
  ...
  const goToApplicationFormButton = document.getElementById(
    "goToApplicationForm"
  );
  ...
  const goToApplicationFormAfterResetButton = document.getElementById(
    "goToApplicationFormAfterReset"
  );
