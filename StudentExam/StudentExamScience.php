...
if (!isset($_SESSION['randomized_science_questions'])) {

    $sql_science = "SELECT questionID, questionText, ChoiceA, ChoiceB, ChoiceC, ChoiceD FROM admin_science";
    $result_science = $conn->query($sql_science);

    $questions = [];
    while ($row = $result_science->fetch_assoc()) {
        $questions[] = $row;
    }
    shuffle($questions);

    $_SESSION['randomized_science_questions'] = $questions;
} else {
    $questions = $_SESSION['randomized_science_questions'];
}

// $sql_science = "SELECT questionID, questionText, ChoiceA, ChoiceB, ChoiceC, ChoiceD 
//              FROM admin_science LIMIT $offset, $page_size";
// $result_science = $conn->query($sql_science);
...
<head>
    ...
    <title>Student Exam Science</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600&display=swap">
    <link rel="stylesheet" href="SPES.css">
</head>
            ...
            <div class="content" id="content">
                ...
                <div class="main-exam-container">
                    ...
                    <div class="exam-container">
                        <!-- Your  content here -->
                        <form method="post" action="StudentExamScience.php">
                            ...
                            <div class="pagination">
                                ...
                                // $sql_count = "SELECT COUNT(*) AS total FROM admin_science";
                            ...
                            <div class="navigation-buttons">
                                ...
                                // } else {
                                //     echo '<button class="back-button" disabled>Back</button>';
                                // }
                                if ($page_number == 1) {
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                if (isset($_POST['submitAnswers'])) {
                                    ...
                                    if ($answers_valid && !empty($answers)) {
                                        ...
                                        $stmt_insert = $conn->prepare("INSERT INTO student_answer_science (control_number, Answer, questionID) VALUES (?, ?, ?)");

                                        foreach ($answers as $questionID => $answer) {

                                            $stmt_insert->bind_param("iss", $student_id, $answer, $questionID);
                                            unset($_SESSION['randomized_science_questions']);
                                        ...
                                        $sql_answer_key = "SELECT questionID, AnswerKey FROM admin_science";
                                        ...
                                        foreach ($answers as $questionID => $student_answer) {
                                            if (isset($answer_key[$questionID])) {
                                                ...
                                                // Check if student's answer matches the AnswerKey
                                        ...
                                        $stmt_score = $conn->prepare("UPDATE student_examination_score SET science_id = ? WHERE control_number = ?");
                                        $stmt_score->bind_param("si", $total_score, $control_number);
                                        ...
                                        echo "<script>
                    Swal.fire({
                        title: 'Third Category Completed!',
                        text: 'Answers submitted successfully.',
                        icon: 'success',
                        confirmButtonText: 'OK'
                    }).then(() => {
                        window.location.href = 'StudentExamReading.php';
                    });
                </script>";
                                    } else {
