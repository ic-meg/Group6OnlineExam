...
// Store the start time of the exam in session if not already set
if (!isset($_SESSION['exam_start_time'])) {
    $_SESSION['exam_start_time'] = time(); // Store current timestamp
}

// Store remaining time in session if not already set
if (!isset($_SESSION['remaining_time'])) {
    $_SESSION['remaining_time'] = 3600; // Initial remaining time (in seconds), adjust as needed
}

// Define pagination parameters
$page_size = 18; // Number of questions per page
$page_number = isset($_GET['page']) ? $_GET['page'] : 1; // Current page number, default to 1

// Calculate offset based on page number and page size
$offset = ($page_number - 1) * $page_size;

// Example: Fetch questions for the Math exam with pagination
            ...
            <div class="content" id="content">
                ...
                <div class="main-exam-container">
                    ...
                    <div class="exam-container">
                        ...
                        <?php
                        $question_number = ($page_number - 1) * $page_size + 1; // Calculate starting question number
            ...
            if ($answers_valid && !empty($answers)) {
                ...
                echo "<script>
                    Swal.fire({
                        ...
                        window.location.href = 'http://localhost/Group6OnlineExam/StudentExamSubmitted.php';
                    });
                </script>";
            } else {
