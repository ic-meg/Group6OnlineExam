...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10/dist/sweetalert2.min.js"></script>
    ...
    border-right: 5px solid white;
        ...
        @media (max-width: 768px) {
        .student-requirements_container, .generalDetailsForStudents {
            max-width: 90%;
        }

        .vh-100 {
            min-height: 100vh;
            padding-top: 50px; /* Adjust padding for spacing */
        }
...
<body>
    ...
    <script>
        // Ensure custom file input labels display the selected file name
...
if (isset($_POST["submit"])) {
    ...
    if (!empty($_POST["firstname"]) && !empty($_POST["lastname"]) &&
        ...
        if ($stmt_std_tbl->execute()) {
            ...
            // Move uploaded files
            if (move_uploaded_file($temp_form137, $form137) && 
                ...
                $stmt_update_booking->bind_param("i", $student_id); // Assuming Student_ID is integer type
